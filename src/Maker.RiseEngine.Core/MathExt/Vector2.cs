...
//        {
//            return new Vector2(
//                Values.Barycentric(value1.X, value2.X, value3.X, amount1, amount2),
//                Values.Barycentric(value1.Y, value2.Y, value3.Y, amount1, amount2));
//        }
...
//        {
//            result.X = Values.Barycentric(value1.X, value2.X, value3.X, amount1, amount2);
//            result.Y = Values.Barycentric(value1.Y, value2.Y, value3.Y, amount1, amount2);
//        }
...
//        {
//            return new Vector2(
//                Values.CatmullRom(value1.X, value2.X, value3.X, value4.X, amount),
//                Values.CatmullRom(value1.Y, value2.Y, value3.Y, value4.Y, amount));
//        }
...
//        {
//            result.X = Values.CatmullRom(value1.X, value2.X, value3.X, value4.X, amount);
//            result.Y = Values.CatmullRom(value1.Y, value2.Y, value3.Y, value4.Y, amount);
//        }
...
//        {
//            return new Vector2(
//                Values.Clamp(value1.X, min.X, max.X),
//                Values.Clamp(value1.Y, min.Y, max.Y));
//        }
...
//        {
//            result.X = Values.Clamp(value1.X, min.X, max.X);
//            result.Y = Values.Clamp(value1.Y, min.Y, max.Y);
//        }
...
//        {
//            return new Vector2(Values.Hermite(value1.X, tangent1.X, value2.X, tangent2.X, amount), Values.Hermite(value1.Y, tangent1.Y, value2.Y, tangent2.Y, amount));
//        }
...
//        {
//            result.X = Values.Hermite(value1.X, tangent1.X, value2.X, tangent2.X, amount);
//            result.Y = Values.Hermite(value1.Y, tangent1.Y, value2.Y, tangent2.Y, amount);
//        }
...
//        {
//            return new Vector2(
//                Values.Lerp(value1.X, value2.X, amount),
//                Values.Lerp(value1.Y, value2.Y, amount));
//        }
...
//        {
//            result.X = Values.Lerp(value1.X, value2.X, amount);
//            result.Y = Values.Lerp(value1.Y, value2.Y, amount);
//        }

//        /// <summary>
//        /// Creates a new <see cref="Vector2"/> that contains linear interpolation of the specified vectors.
//        /// Uses <see cref="Values.LerpPrecise"/> on MathHelper for the interpolation.
//        /// Less efficient but more precise compared to <see cref="Vector2.Lerp(Vector2, Vector2, float)"/>.
//        /// See remarks section of <see cref="Values.LerpPrecise"/> on MathHelper for more info.
//        /// </summary>
//        /// <param name="value1">The first vector.</param>
//        /// <param name="value2">The second vector.</param>
//        /// <param name="amount">Weighting value(between 0.0 and 1.0).</param>
...
//        {
//            return new Vector2(
//                Values.LerpPrecise(value1.X, value2.X, amount),
//                Values.LerpPrecise(value1.Y, value2.Y, amount));
//        }
...
//        {
//            result.X = Values.LerpPrecise(value1.X, value2.X, amount);
//            result.Y = Values.LerpPrecise(value1.Y, value2.Y, amount);
//        }
...
//        {
//            return new Vector2(
//                Values.SmoothStep(value1.X, value2.X, amount),
//                Values.SmoothStep(value1.Y, value2.Y, amount));
//        }
...
//        {
//            result.X = Values.SmoothStep(value1.X, value2.X, amount);
//            result.Y = Values.SmoothStep(value1.Y, value2.Y, amount);
//        }
